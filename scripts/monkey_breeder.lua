...
-- With 140 breeds per minute (5 breeders), it takes about 60 minutes to increase a stats by 100
...
function breed(monkey1, monkey2)
	...
	if not valid1 or not valid2 then return end
	...
	local statsTags = {
		smarts = newSmart,
		meticulousness = newMeticulousness,
