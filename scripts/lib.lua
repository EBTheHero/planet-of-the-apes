...
function verify_monkey(itemstack)
	if not itemstack.valid_for_read then return false end
...
function breeder_has_monkeys(breeder_data)
	slotonevalid = breeder_data.slot1
		and breeder_data.slot1.valid
		and breeder_data.slot1.valid_for_read
	slottwovalid = breeder_data.slot2
		and breeder_data.slot2.valid
		and breeder_data.slot2.valid_for_read

	if slotonevalid and slottwovalid then
		return breeder_data.slot1.name == "monkey"
			and breeder_data.slot2.name == "monkey"
	else
		return false
	end
end
...
function get_name() return names[math.random(1, #names)] end
