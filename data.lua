...
icon_path = "__planet-of-the-apes__/graphics/icons/"
buildings_path = "__planet-of-the-apes__/graphics/buildings/"
sounds_path = "__planet-of-the-apes__/sounds/"
...
require("prototypes.monkey-captcha-solver")

--And these two make defining common file paths much shorter.
local function sprite(name) return "__planet-of-the-apes__/graphics/" .. name end

local function sound(name) return "__planet-of-the-apes__/sound/" .. name end
...
data:extend({
	...
	{
		type = "recipe-category",
		name = "monkey-workstation-exclusive",
	},
})

local no_base_connector_template =
	util.table.deepcopy(universal_connector_template)
...
local connector =
	circuit_connector_definitions.create_vector(no_base_connector_template, {
		{
