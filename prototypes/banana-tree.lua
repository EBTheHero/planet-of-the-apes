local variation = {{
      trunk = {
        filename = "__planet-of-the-apes__/sprite/entity/banana-tree/banana-tree.png",
        flags = { "mipmap" },
        surface = "gleba",
        width = 1024,
        height = 1024,
      ...
      leaves = {
        filename = "__planet-of-the-apes__/sprite/entity/banana-tree/leaves-transparent.png",
        flags = { "mipmap" },
        surface = "gleba",
        width = 1024,
        height = 1024,
      ...
      shadow = {
        ...
        flags = { "mipmap", "shadow" },
        surface = "gleba",
        filename = "__planet-of-the-apes__/sprite/entity/banana-tree/shadow.png",
        width = 1024,
        height = 1024,
        x = 0,
        y = 0,
