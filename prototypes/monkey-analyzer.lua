...
dummycombinator.flags =
	{ "not-on-map", "not-deconstructable", "not-selectable-in-game" }
...
local dummycombinator_item =
	table.deepcopy(data.raw["item"]["constant-combinator"])
...
data.raw["mod-data"]["things-names"].data["monkey-analyzer-combinator"] =
	comb_thing_registration
...
data.raw["mod-data"]["things-names"].data["monkey-analyzer"] =
